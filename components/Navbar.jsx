  ...
  return (
    <div style={{backgroundColor :`${colour}`}} className='fixed left-0 top-0 w-full z-10 ease-in duration-300'>
        <div className='max-w-[1240px] m-auto flex justify-between items-center p-4 text-white '>
           <Link href='/'>
            <h1 style={{color :`${textColour}`}}className='font-bold text-4xl'>CG foto</h1>
           </Link>
            ...
            <div onClick={handleNav} className='block sm:hidden z-10'>
                {nav ?<AiOutlineClose size={20} style={{backgroundColor:`${colour}`}}/> :<AiOutlineMenu size={20} style={{backgroundColor:`${colour}`}}/> }
            </div>
            {/*Mobile menu */}
